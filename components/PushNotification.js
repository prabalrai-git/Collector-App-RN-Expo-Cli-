...
export const PushNotification = async (task, fromSend, ToSend, pathname, Remarks, fromName, RequestPatientname) => {
  ...
  if (task === 'rejected task') {
    ...
    message = {
      ...
      body: Remarks === undefined || Remarks === '' ? `${fromName} rejeted the task of ${RequestPatientname}` : `Collector name:${RequestPatientname}, remarks: ${Remarks}`,
      data: {
        "EntryDate": newDate,
  ...
  if (task === 'asigned task') {
    ...
    message = {
      ...
      body: Remarks === undefined || Remarks === '' ? `please review the asigned task of ${RequestPatientname}` : `Patient name:${RequestPatientname}, remarks: ${Remarks}`,
      data: {
        "EntryDate": newDate,
        "NotficationPathName": pathname,
      },
    ...
    data = {
      ...
      "NotificationDesc": Remarks === undefined || Remarks === '' ? `please review the asigned task of ${RequestPatientname}` : `Patient name:${RequestPatientname}, remarks: ${Remarks}`,
      "EntryDate": newDate,
      "NotficationPathName": pathname,
      "IsSeen": false
    }
  ...
  if (task === 'accepted task') {
    ...
    message = {
      ...
      body: Remarks === undefined || Remarks === '' ? `${fromName} accepted task of ${RequestPatientname}` : `Patinet name:${RequestPatientname}, remarks: ${Remarks}`,
      data: {
        "EntryDate": newDate,
        "NotficationPathName": pathname,
      },
    ...
    data = {
      ...
      "UserIdTo": ToSend,
      "Title": `Task accepted`,
      "NotificationDesc": Remarks === undefined || Remarks === '' ? `${fromName} accepted task of ${RequestPatientname}` : `Patinet name:${RequestPatientname}, remarks: ${Remarks}`,
      "EntryDate": newDate,
      "NotficationPathName": pathname,
      "IsSeen": false
    }
  ...
  if (task === 'sample collected') {
    ...
    message = {
      ...
      body: Remarks === undefined || Remarks === '' ? `${fromName} collected sample of ${RequestPatientname}` : `Patinet name:${RequestPatientname}, remarks: ${Remarks}`,
      data: {
        "EntryDate": newDate,
        "NotficationPathName": pathname,
      },
    ...
    data = {
      ...
      "NotificationDesc": Remarks === undefined || Remarks === '' ? `${fromName} collected sample of ${RequestPatientname}` : `Patinet name:${RequestPatientname}, remarks: ${Remarks}`,
      "EntryDate": newDate,
      "NotficationPathName": pathname,
      "IsSeen": false
    }
